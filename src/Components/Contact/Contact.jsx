  ...
  return (
    ...
    >
      <div className={styles.container}>
        ...
        <p style={{ color: `${newTheme.para}` }} className={styles.paragraph}>
          ...
          <p style={{ color: `#00a0a0`, lineHeight: ``,fontSize:`20px` }}>
            {/* {" "} */}
            Email: sneha052020@gmail.com
          </p>

		  <p style={{ color: `#00a0a0`,fontSize:`20px`}}>
		  Mobile: +91-<span style={{ color: `#00a0a0`, fontSize:`20px`, textDecoration: `underline` }} >7827536571</span>{'\u00A0'}{'\u00A0'}{'\u00A0'}{'\u00A0'}{'\u00A0'}{'\u00A0'}
          </p>
		  <p style={{ color: `#00a0a0`,fontSize:`20px` }}>
        ...
        >
          ...
          <a
            href="mailto: sneha052020@gmail.com"
            aria-label="email"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://github.com/sneha052022"
            aria-label="GitHub"
            rel="noreferrer"
            target="_blank"
          >
          ...
          <a
            href="https://www.linkedin.com/in/sneha-sneha-a78233223"
            aria-label="Linkedin"
            target="_blank"
            rel="noreferrer"
          >
      ...
      <div style={{ color: `${newTheme.para}` }} className={styles.copyright}>
        Designed and build by Sneha, 2022 All rights reserved.
      </div>
    </footer>
  );
};
